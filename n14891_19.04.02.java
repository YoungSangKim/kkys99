...
// N±ÿ 0 S±ÿ 1 Ω√∞ËπÊ«‚ 1 π›Ω√∞Ë -1
	...
	public static void rotation() {
		if (ch[0] == 1) move(chain1, dr[0]);
		if (ch[1] == 1) move(chain2, dr[1]);
		if (ch[2] == 1) move(chain3, dr[2]);
		if (ch[3] == 1) move(chain4, dr[3]);
	}
	...
	public static void make1(String s) {
		for (int i = 0; i < s.length(); i++) chain1[i] = s.charAt(i) - '0';
	}

	public static void make2(String s) {
		for (int i = 0; i < s.length(); i++) chain2[i] = s.charAt(i) - '0';
	}

	public static void make3(String s) {
		for (int i = 0; i < s.length(); i++) chain3[i] = s.charAt(i) - '0';
	}

	public static void make4(String s) {
		for (int i = 0; i < s.length(); i++) chain4[i] = s.charAt(i) - '0';
	}
